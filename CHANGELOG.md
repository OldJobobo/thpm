...
- Ship an Omarchy Spicetify companion stylesheet and initialize it when Spotify's selected `omarchy` theme is missing `user.css`, without overwriting or removing user-owned styles.
