...
def _generated_steam_css(colors: dict[str, str]) -> str:
    ...
    accent = "accent" if "accent" in colors else "blue"
    return f"""/* Generated by THPM from Omarchy's normalized semantic palette.
 * Variable contract reproduced from the original imbypass Steam hook.
 */
:root {{
  --adw-color-scheme: {colors['mode']} !important;
  --adw-accent-bg-rgb: {rgb(accent)} !important;
  --adw-accent-fg-rgb: {rgb('bg')} !important;
  --adw-accent-rgb: {rgb(accent)} !important;

  --adw-destructive-bg-rgb: {rgb('red')} !important;
  --adw-destructive-fg-rgb: {rgb('fg')} !important;
  --adw-destructive-rgb: {rgb('red')} !important;

  --adw-success-bg-rgb: {rgb('green')} !important;
  --adw-success-fg-rgb: {rgb('dark_bg')} !important;
  --adw-success-rgb: {rgb('green')} !important;

  --adw-warning-bg-rgb: {rgb('yellow')} !important;
  --adw-warning-fg-rgb: {rgb('bg')} !important;
  --adw-warning-fg-a: 0.8 !important;
  --adw-warning-rgb: {rgb('yellow')} !important;

  --adw-error-bg-rgb: {rgb('red')} !important;
  --adw-error-fg-rgb: {rgb('dark_bg')} !important;
  --adw-error-rgb: {rgb('red')} !important;

  --adw-window-bg-rgb: {rgb('bg')} !important;
  --adw-window-fg-rgb: {rgb('fg')} !important;

  --adw-view-bg-rgb: {rgb('dark_bg')} !important;
  --adw-view-fg-rgb: {rgb('fg')} !important;

  --adw-headerbar-bg-rgb: {rgb('bg')} !important;
  --adw-headerbar-fg-rgb: {rgb('fg')} !important;
  --adw-headerbar-border-rgb: {rgb('muted')} !important;
  --adw-headerbar-backdrop-rgb: {rgb('dark_bg')} !important;
  ...
  --adw-sidebar-bg-rgb: {rgb('bg')} !important;
  --adw-sidebar-fg-rgb: {rgb('fg')} !important;
  --adw-sidebar-backdrop-rgb: {rgb('dark_bg')} !important;
  --adw-sidebar-shade-rgb: 0, 0, 0 !important;
  --adw-sidebar-shade-a: 0.36 !important;
  --adw-secondary-sidebar-bg-rgb: {rgb('bg')} !important;
  --adw-secondary-sidebar-fg-rgb: {rgb('fg')} !important;
  --adw-secondary-sidebar-backdrop-rgb: {rgb('dark_bg')} !important;
  ...
  --adw-dialog-bg-rgb: {rgb('bg')} !important;
  --adw-dialog-fg-rgb: {rgb('fg')} !important;
  --adw-popover-bg-rgb: {rgb('bg')} !important;
  --adw-popover-fg-rgb: {rgb('fg')} !important;
  --adw-popover-shade-rgb: 0, 0, 0 !important;
  --adw-popover-shade-a: 0.36 !important;
  --adw-thumbnail-bg-rgb: {rgb('bg')} !important;
  --adw-thumbnail-fg-rgb: {rgb('fg')} !important;
