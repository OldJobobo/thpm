...
PLUGINS: tuple[Plugin, ...] = (
    ...
    Plugin("swaync", "SwayNC (experimental)", "Desktop", "Experimentally install optional SwayNC colors and reload; disabled by default until end-to-end stylesheet loading is validated.", "apply", ("swaync-client",), theme_assets=("colors.css",), default_enabled=False),
