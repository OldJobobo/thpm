...
PLUGINS: tuple[Plugin, ...] = (
    ...
    Plugin("zed-extra", "Zed authored theme", "Editors", "Install and select a validated zed.json or aether.zed.json override as the stable THPM Current theme.", "apply", ("zeditor",), theme_assets=("zed.json", "aether.zed.json"), default_enabled=False, confirmation=True),
